...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/yaqd-seabreeze-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10386&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/yaqd-seabreeze-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `yaqd-seabreeze` can be installed with:

```
conda install yaqd-seabreeze
```

It is possible to list all of the versions of `yaqd-seabreeze` available on your platform with:
